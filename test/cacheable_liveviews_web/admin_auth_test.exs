defmodule CacheableLiveviewsWeb.AdminAuthTest do
  use CacheableLiveviewsWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias CacheableLiveviews.Backoffice
  alias CacheableLiveviewsWeb.AdminAuth
  import CacheableLiveviews.BackofficeFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CacheableLiveviewsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CacheableLiveviewsWeb.Endpoint.subscribe(live_socket_id)
