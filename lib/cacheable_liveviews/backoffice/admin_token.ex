defmodule CacheableLiveviews.Backoffice.AdminToken do
  use Ecto.Schema
  import Ecto.Query
  alias CacheableLiveviews.Backoffice.AdminToken
  ...
  schema "admins_tokens" do
    ...
    belongs_to :admin, CacheableLiveviews.Backoffice.Admin
